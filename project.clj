...
(defproject hexagram30/redisgraph-db-plugin "0.1.0-SNAPSHOT"
  :description "A hexagram30 db plugin for RedisGraph"
  :url "https://github.com/hexagram30/redisgraph-db-plugin"
  :license {
  ...
  :profiles {
    ...
    :dev {
      ...
      :repl-options {
        :init-ns hxgm30.db.plugin.redisgraph.repl
        :prompt ~get-prompt
